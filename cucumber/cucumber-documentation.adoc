...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('After-Hooks');document.getElementById('hidden-After-Hooks').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-After-Hooks" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('After-Hooks'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Alle-bruker-ikke-UTF-8');document.getElementById('hidden-Alle-bruker-ikke-UTF-8').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Alle-bruker-ikke-UTF-8" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Alle-bruker-ikke-UTF-8'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Around-hooks');document.getElementById('hidden-Around-hooks').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Around-hooks" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Around-hooks'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Before-Hook');document.getElementById('hidden-Before-Hook').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Before-Hook" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Before-Hook'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Choosing-the-language-from-the-feature-file-header');document.getElementById('hidden-Choosing-the-language-from-the-feature-file-header').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Choosing-the-language-from-the-feature-file-header" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Choosing-the-language-from-the-feature-file-header'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Cucumber---work-in-progress-switch');document.getElementById('hidden-Cucumber---work-in-progress-switch').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Cucumber---work-in-progress-switch" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Cucumber---work-in-progress-switch'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Custom-filter');document.getElementById('hidden-Custom-filter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Custom-filter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Custom-filter'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Custom-Formatter');document.getElementById('hidden-Custom-Formatter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Custom-Formatter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Custom-Formatter'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Debug-formatter');document.getElementById('hidden-Debug-formatter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Debug-formatter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Debug-formatter'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Doc-strings');document.getElementById('hidden-Doc-strings').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Doc-strings" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Doc-strings'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Dry-Run');document.getElementById('hidden-Dry-Run').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Dry-Run" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Dry-Run'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('ERB-configuration');document.getElementById('hidden-ERB-configuration').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-ERB-configuration" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('ERB-configuration'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Exception-in-After-Block');document.getElementById('hidden-Exception-in-After-Block').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Exception-in-After-Block" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Exception-in-After-Block'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Exception-in-AfterStep-Block');document.getElementById('hidden-Exception-in-AfterStep-Block').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Exception-in-AfterStep-Block" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Exception-in-AfterStep-Block'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Exception-in-Before-Block');document.getElementById('hidden-Exception-in-Before-Block').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Exception-in-Before-Block" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Exception-in-Before-Block'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Exceptions-in-Around-Hooks');document.getElementById('hidden-Exceptions-in-Around-Hooks').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Exceptions-in-Around-Hooks" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Exceptions-in-Around-Hooks'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Excluding-ruby-and-feature-files-from-runs');document.getElementById('hidden-Excluding-ruby-and-feature-files-from-runs').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Excluding-ruby-and-feature-files-from-runs" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Excluding-ruby-and-feature-files-from-runs'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Formatter-API:-Step-file-path-and-line-number-(Issue-#179)');document.getElementById('hidden-Formatter-API:-Step-file-path-and-line-number-(Issue-#179)').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Formatter-API:-Step-file-path-and-line-number-(Issue-#179)" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Formatter-API:-Step-file-path-and-line-number-(Issue-#179)'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Getting-started');document.getElementById('hidden-Getting-started').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Getting-started" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Getting-started'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Handle-unexpected-response');document.getElementById('hidden-Handle-unexpected-response').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Handle-unexpected-response" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Handle-unexpected-response'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Hooks-execute-in-defined-order');document.getElementById('hidden-Hooks-execute-in-defined-order').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Hooks-execute-in-defined-order" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Hooks-execute-in-defined-order'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('HTML-output-formatter');document.getElementById('hidden-HTML-output-formatter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-HTML-output-formatter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('HTML-output-formatter'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Invoke-message');document.getElementById('hidden-Invoke-message').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Invoke-message" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Invoke-message'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('JSON-output-formatter');document.getElementById('hidden-JSON-output-formatter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-JSON-output-formatter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('JSON-output-formatter'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('JUnit-output-formatter');document.getElementById('hidden-JUnit-output-formatter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-JUnit-output-formatter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('JUnit-output-formatter'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Language-help');document.getElementById('hidden-Language-help').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Language-help" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Language-help'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('List-step-defs-as-json');document.getElementById('hidden-List-step-defs-as-json').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-List-step-defs-as-json" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('List-step-defs-as-json'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Loading-the-steps-users-expect');document.getElementById('hidden-Loading-the-steps-users-expect').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Loading-the-steps-users-expect" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Loading-the-steps-users-expect'); this.style.display = 'none'">  </span>
++++
****
As a User +
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Nested-Steps');document.getElementById('hidden-Nested-Steps').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Nested-Steps" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Nested-Steps'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Nested-Steps-in-I18n');document.getElementById('hidden-Nested-Steps-in-I18n').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Nested-Steps-in-I18n" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Nested-Steps-in-I18n'); this.style.display = 'none'">  </span>
++++
==== Scenario: Use #steps to call several steps at once
****
Given ::
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Nested-Steps-with-either-table-or-doc-string');document.getElementById('hidden-Nested-Steps-with-either-table-or-doc-string').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Nested-Steps-with-either-table-or-doc-string" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Nested-Steps-with-either-table-or-doc-string'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('One-line-step-definitions');document.getElementById('hidden-One-line-step-definitions').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-One-line-step-definitions" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('One-line-step-definitions'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Post-Configuration-Hook-[#423]');document.getElementById('hidden-Post-Configuration-Hook-[#423]').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Post-Configuration-Hook-[#423]" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Post-Configuration-Hook-[#423]'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Pretty-formatter---Printing-messages');document.getElementById('hidden-Pretty-formatter---Printing-messages').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Pretty-formatter---Printing-messages" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Pretty-formatter---Printing-messages'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Pretty-output-formatter');document.getElementById('hidden-Pretty-output-formatter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Pretty-output-formatter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Pretty-output-formatter'); this.style.display = 'none'">  </span>
++++
==== Scenario: an scenario outline, one undefined step, one random example, expand flag on
****
When ::
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Profiles');document.getElementById('hidden-Profiles').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Profiles" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Profiles'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Progress-output-formatter');document.getElementById('hidden-Progress-output-formatter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Progress-output-formatter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Progress-output-formatter'); this.style.display = 'none'">  </span>
++++
==== Scenario: an scenario outline, one undefined step, one random example, expand flag on
****
When ::
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Rake-task');document.getElementById('hidden-Rake-task').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Rake-task" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Rake-task'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Raketask');document.getElementById('hidden-Raketask').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Raketask" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Raketask'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Randomize');document.getElementById('hidden-Randomize').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Randomize" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Randomize'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Requiring-extra-step-files');document.getElementById('hidden-Requiring-extra-step-files').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Requiring-extra-step-files" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Requiring-extra-step-files'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Rerun-formatter');document.getElementById('hidden-Rerun-formatter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Rerun-formatter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Rerun-formatter'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Run-Cli::Main-with-existing-Runtime');document.getElementById('hidden-Run-Cli::Main-with-existing-Runtime').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Run-Cli::Main-with-existing-Runtime" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Run-Cli::Main-with-existing-Runtime'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Run-feature-elements-matching-a-name-with---name/-n');document.getElementById('hidden-Run-feature-elements-matching-a-name-with---name/-n').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Run-feature-elements-matching-a-name-with---name/-n" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Run-feature-elements-matching-a-name-with---name/-n'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Run-specific-scenarios');document.getElementById('hidden-Run-specific-scenarios').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Run-specific-scenarios" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Run-specific-scenarios'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Running-multiple-formatters');document.getElementById('hidden-Running-multiple-formatters').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Running-multiple-formatters" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Running-multiple-formatters'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Scenario-outlines');document.getElementById('hidden-Scenario-outlines').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Scenario-outlines" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Scenario-outlines'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Scenario-outlines---expand-option');document.getElementById('hidden-Scenario-outlines---expand-option').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Scenario-outlines---expand-option" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Scenario-outlines---expand-option'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Set-up-a-default-load-path');document.getElementById('hidden-Set-up-a-default-load-path').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Set-up-a-default-load-path" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Set-up-a-default-load-path'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Showing-differences-to-expected-output');document.getElementById('hidden-Showing-differences-to-expected-output').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Showing-differences-to-expected-output" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Showing-differences-to-expected-output'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Skip-Scenario');document.getElementById('hidden-Skip-Scenario').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Skip-Scenario" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Skip-Scenario'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Snippets');document.getElementById('hidden-Snippets').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Snippets" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Snippets'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Snippets-message');document.getElementById('hidden-Snippets-message').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Snippets-message" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Snippets-message'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('State');document.getElementById('hidden-State').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-State" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('State'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Step-matches-message');document.getElementById('hidden-Step-matches-message').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Step-matches-message" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Step-matches-message'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Table-diffing');document.getElementById('hidden-Table-diffing').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Table-diffing" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Table-diffing'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Tag-logic');document.getElementById('hidden-Tag-logic').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Tag-logic" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Tag-logic'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Tagged-hooks');document.getElementById('hidden-Tagged-hooks').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Tagged-hooks" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Tagged-hooks'); this.style.display = 'none'">  </span>
++++
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Transforms');document.getElementById('hidden-Transforms').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Transforms" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Transforms'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Unicode-in-tables');document.getElementById('hidden-Unicode-in-tables').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Unicode-in-tables" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Unicode-in-tables'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Usage-formatter');document.getElementById('hidden-Usage-formatter').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Usage-formatter" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Usage-formatter'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Using-descriptions-to-give-features-context');document.getElementById('hidden-Using-descriptions-to-give-features-context').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Using-descriptions-to-give-features-context" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Using-descriptions-to-give-features-context'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Using-star-notation-instead-of-Given/When/Then');document.getElementById('hidden-Using-star-notation-instead-of-Given/When/Then').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Using-star-notation-instead-of-Given/When/Then" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Using-star-notation-instead-of-Given/When/Then'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Wire-protocol-table-diffing');document.getElementById('hidden-Wire-protocol-table-diffing').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Wire-protocol-table-diffing" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Wire-protocol-table-diffing'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Wire-protocol-tags');document.getElementById('hidden-Wire-protocol-tags').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Wire-protocol-tags" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Wire-protocol-tags'); this.style.display = 'none'">  </span>
++++
****
...
++++
<span class="fa fa-minus-square fa-fw" style="cursor:pointer;float:right;margin-top:-30px" title="minimize" onclick="hideFeatureScenarios('Wire-protocol-timeouts');document.getElementById('hidden-Wire-protocol-timeouts').style.display = 'inline';this.style.display = 'none'">  </span>

<span id="hidden-Wire-protocol-timeouts" class="fa fa-plus-square fa-fw" style="cursor:pointer;float:right;display:none;margin-top:-30px" title="maximize feature" onclick="showFeatureScenarios('Wire-protocol-timeouts'); this.style.display = 'none'">  </span>
++++
****
