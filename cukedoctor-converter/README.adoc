...
Cukedoctor comes with some extensions to enhance and customize its documentation content, for more details see https://github.com/rmpestano/cukedoctor/tree/master/cukedoctor-converter#disable-extensions[cukedoctor extensions module^].
