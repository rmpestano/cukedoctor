...
public class CukedoctorDocumentBuilderImplTest {
  ...
  public void shouldRenderTitleAtLevel1AfterNestingOnce() {
    builder.title(level0Title).nestTitle().title(level1Title).title("Other " + level1Title);
  ...
  public void shouldRenderTitleAtPreviousLevelAfterPopping() {
    builder
        ...
        .title(level5Title)
        .unNestTitle()
        .title("Second " + level4Title)
        .nestTitle()
        .title("Second " + level5Title)
        .unNestTitle()
        .title("Third " + level4Title)
        .unNestTitle()
        .title("Second " + level3Title)
        .unNestTitle()
        .title("Second " + level2Title)
        .unNestTitle()
        .title("Second " + level1Title)
        .unNestTitle()
  ...
  public void shouldRenderTitleAndAdvanceToNextNestLevel() {
    ...
    assertDocumentEquals("= " + level0Title + newLine() + newLine() + "== " + level1Title);
  }
  ...
  public void nestedBuilderShouldRenderAtLevel2IfParentWasAtLevel1() {
    ...
    assertEquals(
        "= My Level 0 Title" + newLine() + newLine(), builder.title("My Level 0 Title").toString());
  ...
  public void peerBuilderShouldRenderAtSameLevelAsParent() {
    ...
    assertEquals(
        "== Parent Level 1 Title" + newLine(), parent.title("Parent Level 1 Title").toString());
  ...
  private CukedoctorDocumentBuilderImpl createInstanceWithNestingLevel2() {
    return (CukedoctorDocumentBuilderImpl)
