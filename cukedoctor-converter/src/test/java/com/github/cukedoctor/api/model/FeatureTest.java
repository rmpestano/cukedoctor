...
public class FeatureTest {
  ...
  public void fixture() {
    ...
    Step step3 =
        StepBuilder.instance().match(new Match("/match2")).name("my step 3").result(result).build();

    Step stepMissing =
        StepBuilder.instance()
            .match(new Match("/match3"))
            .name("step missing")
  ...
  public void shouldProcessSteps() {
    ...
    assertThat(feature.getNumberOfSteps())
        .isEqualTo(7); // 2 steps in scenario 1 and 3 in scenario 2
