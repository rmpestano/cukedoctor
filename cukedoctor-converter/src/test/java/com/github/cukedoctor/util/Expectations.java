...
public interface Expectations {
  ...
  String SUMMARY_FOR_MULTIPLE_FEATURES =
      "== *Summary*"
          ...
          + "12+^|*Totals*"
          + newLine()
          + "|4|1|5|4|1|0|0|0|0|5 2+|010ms"
          + newLine()
          + "|==="
          + newLine();

  String DOCUMENTATION_FOR_ONE_FEATURE =
      ":toc: left"
          + newLine()
          + ":backend: html5"
          + newLine()
  ...
  String DOCUMENTATION_WITHOUT_STEP_TIME =
      ":toc: left"
          ...
          + "Given ::"
          + newLine()
          + "this step passes icon:thumbs-up[role=\"green\",title=\"Passed\"]"
          + newLine()
          + "=========="
          + newLine()
          + ""
  ...
  String FEATURE_WITH_SOURCE_DOC_STRING =
      "[[test, test]]"
          ...
          + "Given ::"
          + newLine()
          + "code icon:thumbs-down[role=\"yellow\",title=\"Undefined\"] [small right]#(000ms)#"
          + newLine()
          + "[source,ruby]"
          + newLine()
          + "----"
