...
public class StringUtilTests {
    ...
    public void shouldTrimAllLines() {
        final String fixture = " \t \tThis is the description for Feature One. The first non-blank line of this description in the feature file began with four whitespace characters." + lineSeparator() +
                "    \t Therefore, cukedoctor will ignore up to the first four" + lineSeparator() +
                "whitespace characters" + lineSeparator() +
                "  in all other lines in the same description," + lineSeparator() +
                "    if any are present." + lineSeparator() +
                "" + lineSeparator() +
                "" + lineSeparator() +
                "This includes" + lineSeparator() +
                "  further lines" + lineSeparator() +
                "    in a different" + lineSeparator() +
                "      paragraph" + lineSeparator() +
                "       \tin the same description.";

        final String expected = "This is the description for Feature One. The first non-blank line of this description in the feature file began with four whitespace characters." + lineSeparator() +
                "\t Therefore, cukedoctor will ignore up to the first four" + lineSeparator() +
                "whitespace characters" + lineSeparator() +
                "in all other lines in the same description," + lineSeparator() +
                "if any are present." + lineSeparator() +
