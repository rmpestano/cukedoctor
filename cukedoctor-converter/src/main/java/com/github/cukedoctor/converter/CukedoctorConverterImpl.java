...
public class CukedoctorConverterImpl implements CukedoctorConverter {
    ...
    public CukedoctorConverter generateDocInfo() {
        if (notNull(documentAttributes) && documentAttributes.isDocInfo()) {
            ...
            FileUtil.copyFile("theme/_all-skins.min.css", basePath + "/_all-skins.min.css");
            FileUtil.copyFile("theme/adminlte.min.css", basePath + "/adminlte.min.css");
            FileUtil.copyFile("theme/bootstrap.min.css", basePath + "/bootstrap.min.css");
            FileUtil.copyFile("theme/adminlte.min.js", basePath + "/adminlte.min.js");
            FileUtil.copyFile("theme/bootstrap.min.js", basePath + "/bootstrap.min.js");
        }
