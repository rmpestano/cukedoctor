...
public abstract class CukedoctorConfig {
	...
	public static final String CUKEDOCTOR_CSS_DIR = getProperty("CUKEDOCTOR_CSS_DIR") == null ? Constants.baseDir : getProperty("CUKEDOCTOR_CSS_DIR");
	public static final String CUKEDOCTOR_PDF_THEME_DIR = getProperty("CUKEDOCTOR_PDF_THEME_DIR") == null ? Constants.baseDir : getProperty("CUKEDOCTOR_PDF_THEME_DIR");
