...
public class BasicSectionTest {
  ...
  public void shouldRenderRootFeatureInsteadOfTitle() {
    ...
    section.addFeature(
        FeatureBuilder.instance()
            ...
            .description("This tells you all about my really cool section.")
    ...
    final String expectedDocument =
        "[[My-Cool-Section, My Cool Section]]"
            ...
            + newLine()
            + newLine()
            + "This tells you all about my really cool section."
            + newLine()
            + newLine()
            + "[[My-First-Child, My First Child]]"
            + newLine()
  ...
  public void shouldRenderFeaturesWithGroup() {
    ...
    section.addFeature(
        FeatureBuilder.instance().name("My First Child").tag("@grouptag-Group1").build());
    final String expectedDocument =
        "[SomeStyle]"
            + newLine()
            + "[[My-Section, My Section]]"
  ...
  public void shouldRenderFeaturesInOrder() {
    ...
    final String expectedDocument =
        "[SomeStyle]"
            ...
            + newLine()
            + newLine()
            + "[[My-Third-Child, My Third Child]]"
            + newLine()
            + "== *My Third Child*"
            + newLine()
            + newLine()
            + "[[My-Fourth-Child, My Fourth Child]]"
            + newLine()
            + "== *My Fourth Child*"
            + newLine()
            + newLine()
            + "[[My-Fifth-Child, My Fifth Child]]"
            + newLine()
            + "== *My Fifth Child*"
            + newLine()
            + newLine();
