...
public class SectionSummaryRendererTest {
    ...
    public void shouldRenderSummaryInOrder() {
        final Feature one = FeatureBuilder.instance().name("one").keyword("Feature").tag("@order-1").tag("@section-one").scenario(ScenarioBuilder.instance().name("Root").build()).build();
        final Feature two = FeatureBuilder.instance().name("two").keyword("Feature").tag("order-2").tag("@section-two").tag("@subsection-one").scenario(ScenarioBuilder.instance().name("Root").build()).build();
        final Feature three = FeatureBuilder.instance().name("three").keyword("Feature").tag("order-3").tag("@section-two").tag("@subsection-one").scenario(ScenarioBuilder.instance().name("Fake").build()).build();
        final Feature four = FeatureBuilder.instance().name("four").keyword("Feature").tag("order-4").tag("@section-three").scenario(ScenarioBuilder.instance().name("Fake").build()).build();
        final Feature five = FeatureBuilder.instance().name("five").keyword("Feature").tag("order-5").scenario(ScenarioBuilder.instance().name("Fake").build()).build();
        final Feature six = FeatureBuilder.instance().name("six").keyword("Feature").tag("order-6").tag("@subsection-one").scenario(ScenarioBuilder.instance().name("Fake").build()).build();
        final Feature seven = FeatureBuilder.instance().name("seven").keyword("Feature").tag("order-7").tag("@appendix").tag("@section-four").tag("@subsection-one").scenario(ScenarioBuilder.instance().name("Root").build()).build();
