  ...
  public void shouldRenderDescriptionInLine() {
    Feature feature =
        FeatureBuilder.instance()
            .id("My Feature")
            .name("My Feature")
            .description("My feature's description")
            .build();
    ...
    String expected =
        "[[My-Feature, My Feature]]"
            ...
            + newLine()
            + newLine()
            + "My feature's description"
            + newLine()
            + newLine();

    String result =
        new NoSideBarBlockFeatureRenderer()
            .renderFeature(feature, CukedoctorDocumentBuilder.Factory.newInstance());
