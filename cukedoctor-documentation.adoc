...
|[green]#*passed*#
12+^|*Totals*
|6|0|6|19|0|0|0|0|0|19 2+|02s 963ms
|===
...
Given ::
=====
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 047ms)#
----
...
When ::
=====
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 508ms)#
******
...
Then ::
=====
I should have awesome living documentation icon:thumbs-up[role="green",title="Passed"] [small right]#(010ms)#
******
...
When ::
=====
I convert them using default order icon:thumbs-up[role="green",title="Passed"] [small right]#(049ms)#
=====
Then ::
=====
...
When ::
=====
I convert them using comment order icon:thumbs-up[role="green",title="Passed"] [small right]#(066ms)#
=====
Then ::
=====
...
When ::
=====
I convert enriched feature json output using cukedoctor icon:thumbs-up[role="green",title="Passed"] [small right]#(131ms)#
=====
Then ::
=====
...
And ::
=====
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(096ms)#
******
