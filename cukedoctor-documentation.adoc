...
|[green]#*passed*#
12+^|*Totals*
|6|0|6|19|0|0|0|0|0|19 2+|03s 369ms
|===
...
Given ::
=====
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 149ms)#
----
...
When ::
=====
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 961ms)#
******
...
When ::
=====
I convert them using default order icon:thumbs-up[role="green",title="Passed"] [small right]#(032ms)#
=====
Then ::
=====
...
When ::
=====
I convert them using comment order icon:thumbs-up[role="green",title="Passed"] [small right]#(070ms)#
=====
Then ::
=====
...
When ::
=====
I convert docstring enriched json output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(049ms)#
=====
Then ::
=====
...
And ::
=====
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(060ms)#
******
