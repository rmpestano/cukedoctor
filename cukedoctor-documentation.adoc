...
----
When ::
I convert enriched docstring with asciidoc feature tag using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(017ms)#
Then ::
DocString asciidoc output must be rendered in my documentation icon:thumbs-up[role="green",title="Passed"] [small right]#(000ms)#
******
...
----
When ::
I convert enriched docstring with asciidoc scenario tag using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(007ms)#
Then ::
DocString asciidoc output must be rendered in my documentation icon:thumbs-up[role="green",title="Passed"] [small right]#(000ms)#
******
...
----
When ::
I render the feature icon:thumbs-up[role="green",title="Passed"] [small right]#(008ms)#
Then ::
...
----
When ::
I render the feature icon:thumbs-up[role="green",title="Passed"] [small right]#(012ms)#
Then ::
