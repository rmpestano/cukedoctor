...
|[red]#*failed*#
12+^|*Totals*
|1|5|6|14|5|0|0|0|0|19 2+|03s 025ms
|===
...
Given ::
=====
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 142ms)#
----
...
When ::
=====
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 660ms)#
******
...
IMPORTANT: org.junit.ComparisonFailure: expected:<... Scenario feature 1
[
****
Given ::
=====
...
****
Given ::
=====...> but was:<... Scenario feature 1
[****
Given ::
=====
scenario step icon:thumbs-up[role="green",title="Passed"] [small right]...
...
IMPORTANT: org.junit.ComparisonFailure: expected:<... Scenario feature 2
[
****
Given ::
=====
...
When ::
=====
I convert docstring enriched json output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(053ms)#
=====
Then ::
=====
...
IMPORTANT: org.junit.ComparisonFailure: expected:<... Render source code
[
****
Given ::
=====
...
When ::
=====
I convert enriched feature json output using cukedoctor icon:thumbs-up[role="green",title="Passed"] [small right]#(042ms)#
=====
Then ::
=====
...
And ::
=====
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(047ms)#
******
