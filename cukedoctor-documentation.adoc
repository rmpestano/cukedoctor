...
----
When ::
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(016ms)#
******
...
----
When ::
I convert them using default order icon:thumbs-up[role="green",title="Passed"] [small right]#(005ms)#
Then ::
...
----
When ::
I convert enriched docstring with asciidoc feature tag using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(014ms)#
Then ::
DocString asciidoc output must be rendered in my documentation icon:thumbs-up[role="green",title="Passed"] [small right]#(000ms)#
******
