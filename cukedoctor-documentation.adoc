...
|[green]#*passed*#
12+^|*Totals*
|5|0|5|15|0|0|0|0|0|15 2+|02s 411ms
|===
...
----
When ::
I convert their json output report using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 931ms)#
******
