...
|[green]#*passed*#
12+^|*Totals*
|4|1|5|14|1|0|0|0|0|15 2+|02s 974ms
|===
...
****
Given ::
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 080ms)#
----
...
----
When ::
I convert their json output report using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 703ms)#
******
...
Then ::
I should have awesome living documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(008ms)#
******
...
----
When ::
I convert them using default order icon:thumbs-up[role="green",title="Passed"] [small right]#(045ms)#
Then ::
