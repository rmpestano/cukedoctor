...
----
When ::
I convert them using default order icon:thumbs-up[role="green",title="Passed"] [small right]#(011ms)#
Then ::
...
----
When ::
I convert them using tag order icon:thumbs-up[role="green",title="Passed"] [small right]#(017ms)#
Then ::
...
----
When ::
I convert enriched docstring with asciidoc content type using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(016ms)#
Then ::
...
----
And ::
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(016ms)#
******
...
----
When ::
I render the feature icon:thumbs-up[role="green",title="Passed"] [small right]#(013ms)#
Then ::
