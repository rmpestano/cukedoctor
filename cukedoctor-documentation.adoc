...
|[green]#*passed*#
12+^|*Totals*
|6|0|6|19|0|0|0|0|0|19 2+|08s 930ms
|===
...
Given ::
=====
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(06s 938ms)#
----
...
When ::
=====
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 792ms)#
******
