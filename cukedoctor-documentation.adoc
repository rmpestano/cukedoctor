...
----
When ::
I convert them using tag order icon:thumbs-up[role="green",title="Passed"] [small right]#(012ms)#
Then ::
...
----
When ::
I convert enriched docstring with asciidoc content type using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(005ms)#
Then ::
...
----
When ::
I convert enriched docstring with asciidoc feature tag using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(005ms)#
Then ::
DocString asciidoc output must be rendered in my documentation icon:thumbs-up[role="green",title="Passed"] [small right]#(000ms)#
******
...
----
When ::
I convert enriched docstring with asciidoc scenario tag using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(004ms)#
Then ::
DocString asciidoc output must be rendered in my documentation icon:thumbs-up[role="green",title="Passed"] [small right]#(000ms)#
******
...
----
And ::
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(008ms)#
******
