...
|[red]#*failed*#
12+^|*Totals*
|0|6|6|13|6|0|0|0|0|19 2+|03s 301ms
|===
...
==== Scenario: Convert features test output into documentation icon:thumbs-down[role="red",title="Failed"]

****
Given ::
=====
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 087ms)#
----
...
When ::
=====
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 922ms)#
******
...
Then ::
=====
I should have awesome living documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(010ms)#
******
...
IMPORTANT: org.junit.ComparisonFailure: expected:<...all right]#(647ms)#
[****
...
==== Scenario: Default ordering icon:thumbs-down[role="red",title="Failed"]
...
When ::
=====
I convert them using default order icon:thumbs-up[role="green",title="Passed"] [small right]#(086ms)#
=====
Then ::
=====
Features should be ordered by name in resulting documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(000ms)#
******
...
IMPORTANT: org.junit.ComparisonFailure: expected:<...re 1
...
Given ::
[=====
scenario step icon:thumbs-up[rol...


=====
****

==== Scenario: Custom ordering icon:thumbs-down[role="red",title="Failed"]
...
When ::
=====
I convert them using comment order icon:thumbs-up[role="green",title="Passed"] [small right]#(033ms)#
=====
Then ::
=====
Features should be ordered respecting order comment icon:thumbs-down[role="red",title="Failed"] [small right]#(000ms)#
******
...
IMPORTANT: org.junit.ComparisonFailure: expected:<...re 2
...
==== Scenario: Introduction chapter in classpath icon:thumbs-down[role="red",title="Failed"]
...
And ::
=====
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(028ms)#
******
...
Then ::
=====
Resulting documentation should have the provided introduction chapter icon:thumbs-down[role="red",title="Failed"] [small right]#(000ms)#
******
...
==== Scenario: DocSting enrichment icon:thumbs-down[role="red",title="Failed"]
...
When ::
=====
I convert docstring enriched json output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(081ms)#
=====
Then ::
=====
DocString asciidoc output must be rendered in my documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(000ms)#
******
...
IMPORTANT: org.junit.ComparisonFailure: expected:<...entation>
...
==== Scenario: Comments enrichment icon:thumbs-down[role="red",title="Failed"]
...
When ::
=====
I convert enriched feature json output using cukedoctor icon:thumbs-up[role="green",title="Passed"] [small right]#(048ms)#
=====
Then ::
=====
Asciidoc markup on comments must be rendered in my documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(000ms)#
******
...
IMPORTANT: org.junit.ComparisonFailure: expected:<...ture!
