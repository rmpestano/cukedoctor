...
|[red]#*failed*#
12+^|*Totals*
|1|5|6|14|5|0|0|0|0|19 2+|04s 928ms
|===
...
Given ::
=====
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 611ms)#
----
...
When ::
=====
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(02s 856ms)#
******
...
Then ::
=====
I should have awesome living documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(028ms)#
******
...
When ::
=====
I convert them using default order icon:thumbs-up[role="green",title="Passed"] [small right]#(087ms)#
=====
Then ::
=====
...
When ::
=====
I convert them using comment order icon:thumbs-up[role="green",title="Passed"] [small right]#(074ms)#
=====
Then ::
=====
...
When ::
=====
I convert docstring enriched json output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(084ms)#
=====
Then ::
=====
DocString asciidoc output must be rendered in my documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(001ms)#
******
...
When ::
=====
I convert enriched feature json output using cukedoctor icon:thumbs-up[role="green",title="Passed"] [small right]#(124ms)#
=====
Then ::
=====
...
And ::
=====
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(055ms)#
******
...
Then ::
=====
Resulting documentation should have the provided introduction chapter icon:thumbs-down[role="red",title="Failed"] [small right]#(001ms)#
******
