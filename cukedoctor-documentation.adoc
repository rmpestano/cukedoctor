...
==== Convert features test output into documentation icon:thumbs-down[role="red",title="Failed"]

====
Given ::
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(509ms)#
----
...
----
When ::
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 172ms)#
******
...
Then ::
I should have awesome living documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(016ms)#
******
...
==== Default ordering icon:thumbs-down[role="red",title="Failed"]
...
----
When ::
I convert them using default order icon:thumbs-up[role="green",title="Passed"] [small right]#(038ms)#
Then ::
...
IMPORTANT: java.lang.AssertionError: 
Expecting:
 <"== *Features*
...
==== Custom ordering icon:thumbs-down[role="red",title="Failed"]
...
When ::
I convert them using comment order icon:thumbs-up[role="green",title="Passed"] [small right]#(046ms)#
Then ::
...
==== DocSting enrichment icon:thumbs-down[role="red",title="Failed"]
...
----
When ::
I convert docstring enriched json output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(097ms)#
Then ::
DocString asciidoc output must be rendered in my documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(003ms)#
******
...
==== Comments enrichment icon:thumbs-down[role="red",title="Failed"]
...
----
When ::
I convert enriched feature json output using cukedoctor icon:thumbs-up[role="green",title="Passed"] [small right]#(029ms)#
Then ::
Asciidoc markup on comments must be rendered in my documentation icon:thumbs-down[role="red",title="Failed"] [small right]#(001ms)#
******
...
NOTE:Stepscommentsareplaced*befo...
...
==== Introduction chapter in classpath icon:thumbs-down[role="red",title="Failed"]
...
----
And ::
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(062ms)#
******
