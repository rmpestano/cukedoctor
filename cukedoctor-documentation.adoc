...
|[green]#*passed*#
12+^|*Totals*
|6|0|6|19|0|0|0|0|0|19 2+|03s 718ms
|===
...
Given ::
=====
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 463ms)#
----
...
When ::
=====
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 957ms)#
******
...
When ::
=====
I convert them using comment order icon:thumbs-up[role="green",title="Passed"] [small right]#(030ms)#
=====
Then ::
=====
...
When ::
=====
I convert docstring enriched json output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(092ms)#
=====
Then ::
=====
...
When ::
=====
I convert enriched feature json output using cukedoctor icon:thumbs-up[role="green",title="Passed"] [small right]#(057ms)#
=====
Then ::
=====
...
And ::
=====
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(092ms)#
******
