...
----
When ::
I convert their json test output using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(013ms)#
******
...
----
When ::
I convert them using tag order icon:thumbs-up[role="green",title="Passed"] [small right]#(006ms)#
Then ::
...
******
When ::
I convert enriched docstring with asciidoc content type using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(014ms)#
Then ::
...
******
When ::
I convert enriched docstring with asciidoc feature tag using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(011ms)#
Then ::
DocString asciidoc output must be rendered in my documentation icon:thumbs-up[role="green",title="Passed"] [small right]#(001ms)#
******
...
******
When ::
I convert enriched docstring with asciidoc scenario tag using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(008ms)#
Then ::
...
----
And ::
The following asciidoc document is on your application classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(010ms)#
----
...
Then ::
Cukedoctor tags should not be rendered in documentation icon:thumbs-up[role="green",title="Passed"] [small right]#(001ms)#
******
