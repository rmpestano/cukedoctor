...
|[green]#*passed*#
12+^|*Totals*
|5|0|5|15|0|0|0|0|0|15 2+|03s 034ms
|===
...
****
Given ::
The following two features: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 230ms)#
----
...
----
When ::
I convert their json output report using cukedoctor converter icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 629ms)#
******
...
----
When ::
I convert them using default order icon:thumbs-up[role="green",title="Passed"] [small right]#(077ms)#
Then ::
