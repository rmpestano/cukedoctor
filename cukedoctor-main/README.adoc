...
image:https://www.versioneye.com/java/com.github.cukedoctor:cukedoctor-main/badge.svg[Dependency Status, link=https://www.versioneye.com/java/com.github.cukedoctor:cukedoctor-main/]
...
You can download Cukedoctor main https://bintray.com/artifact/download/rmpestano/cukedoctor/com/github/cukedoctor/cukedoctor-main/0.5.1/cukedoctor-main-0.5.1.jar[jar here^]
