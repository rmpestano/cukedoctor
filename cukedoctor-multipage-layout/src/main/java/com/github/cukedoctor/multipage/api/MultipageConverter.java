...
public class MultipageConverter {
    ...
    private void loadDependencies() {
        this.pager = new ServiceLoaderUtil<MultipagePager>().initialise(MultipagePager.class, OnePagePerFeatureMultipagePager.class, null, attrs, cukedoctorConfig);
        this.persister = new ServiceLoaderUtil<MultipagePersister>().initialise(MultipagePersister.class, DefaultMultipagePersister.class, null, attrs, cukedoctorConfig);
    }
    ...
    private MultipageDocumentation generateMultipageDocumentation() {
        ...
        cukedoctorConfig.setHideSummarySection(true)
        ...
        for (Page page : pages) {
            CukedoctorConverter converter = Cukedoctor.instance(page.getFeatures(), page.getDocumentAttributes(), cukedoctorConfig);
