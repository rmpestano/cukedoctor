...
public class CukedoctorExtensionRegistry implements ExtensionRegistry {
    ...
    public void register(Asciidoctor asciidoctor) {
        ...
        if (useLegacyThemes()) {
            ...
            cukedoctorExtensionGroup.postprocessor(CukedoctorAdminThemeExtension.class);
        }
    ...
    public static boolean useLegacyThemes() {
        return System.getProperty(CUKEDOCTOR_LEGACY_THEME) != null;
    }
